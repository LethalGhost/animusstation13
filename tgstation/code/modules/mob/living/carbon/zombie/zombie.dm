/mob/living/carbon/zombie/New()
	...
	organStructure.chest.maxHealth = 200
...
/mob/living/carbon/zombie/emp_act(severity)
...
/mob/living/carbon/zombie/u_equip(obj/item/W as obj)
	if (W == wear_suit)
		W = s_store
		if (W)
			u_equip(W)
...
/mob/living/carbon/zombie/db_click(text, t1)
...
/mob/living/carbon/zombie/meteorhit(O as obj)
...
/mob/living/carbon/zombie/Move(a, b, flag)
...
/mob/living/carbon/zombie/update_clothing()
	..()
			...
			/*else if (istype(wear_suit, /obj/item/clothing/suit/swat_suit))
				...
				/*for(var/datum/disease/D in M.viruses)
					if(istype(D, /datum/disease/jungle_fever))
						var/mob/living/carbon/zombie/H = src
						src = null
						src = H.monkeyize()
...
/mob/living/carbon/zombie/attack_metroid(mob/living/carbon/metroid/M as mob)
	if (!ticker)
		M << "You cannot attack people before the game has started."
		return
...
/mob/living/carbon/zombie/attack_hand(mob/living/carbon/zombie/M as mob)
	if (!ticker)
		M << "You cannot attack people before the game has started."
		return
...
/mob/living/carbon/zombie/restrained()
	if (handcuffed)
		return 1
	if (istype(wear_suit, /obj/item/clothing/suit/straight_jacket))
		return 1
...
/mob/living/carbon/zombie/proc/update_body()
	if(stand_icon)
		del(stand_icon)
	if(lying_icon)
		del(lying_icon)
...
/mob/living/carbon/zombie/proc/update_face()
	del(face_standing)
	del(face_lying)
...
/mob/living/carbon/zombie/proc/TakeDamage(zone, brute, burn)
...
/mob/living/carbon/zombie/proc/HealDamage(zone, brute, burn)
...
/mob/living/carbon/zombie/proc/UpdateDamage()
...
/mob/living/carbon/zombie/proc/UpdateDamageIcon()
	del(body_standing)
	body_standing = list()
	del(body_lying)
	body_lying = list()
...
/mob/living/carbon/zombie/show_inv(mob/user as mob)
...
/mob/living/carbon/zombie/HasEntered(var/atom/movable/AM)
...
/mob/living/carbon/zombie/proc/get_assignment(var/if_no_id = "No id", var/if_no_job = "No job")
	var/obj/item/device/pda/pda = wear_id
	var/obj/item/weapon/card/id/id = wear_id
	if (istype(pda))
		if (pda.id)
...
//Useful when player do something with computers
/mob/living/carbon/zombie/proc/get_authentification_name(var/if_no_id = "Unknown")
	var/obj/item/device/pda/pda = wear_id
	var/obj/item/weapon/card/id/id = wear_id
	if (istype(pda))
		if (pda.id)
...
/mob/living/carbon/zombie/proc/get_visible_name(var/if_no_id = "Unknown")
	var/obj/item/device/pda/pda = wear_id
	var/obj/item/weapon/card/id/id = wear_id
	if (istype(pda))
		. = pda.owner
...
/mob/living/carbon/zombie/proc/get_idcard()
	var/obj/item/weapon/card/id/id = wear_id
	var/obj/item/device/pda/pda = wear_id
...
/mob/living/carbon/zombie/electrocute_act(var/shock_damage, var/obj/source, var/siemens_coeff = 1.0, var/safety = 0)
	if(!safety)
		if(gloves)
...
/mob/living/carbon/zombie/proc/get_damaged_organs(var/brute, var/burn)
...
/mob/living/carbon/zombie/proc/get_damageable_organs()
	var/list/datum/organ/external/parts = list()
	for(var/organ_name in organs)
		var/datum/organ/external/organ = organs[organ_name]
...
/mob/living/carbon/zombie/heal_organ_damage(var/brute, var/burn)
...
/mob/living/carbon/zombie/take_organ_damage(var/brute, var/burn)
...
/mob/living/carbon/zombie/heal_overall_damage(var/brute, var/burn)
	var/list/datum/organ/external/parts = get_damaged_organs(brute,burn)
...
/mob/living/carbon/zombie/take_overall_damage(var/brute, var/burn)
	var/list/datum/organ/external/parts = get_damageable_organs()
...
/mob/living/carbon/zombie/proc/getarmor(var/datum/organ/external/def_zone, var/type)
	var/armorval = 0
	var/organnum = 0
...
/mob/living/carbon/zombie/proc/checkarmor(var/datum/organ/external/def_zone, var/type)
	if (!type)
		return
...
/mob/living/carbon/zombie/Topic(href, href_list)
...
/mob/living/carbon/zombie/eyecheck()
